...
# BlackRoad OS - blackroad-code-analyzer
...
```bibtex
@software{blackroad_os_blackroad-code-analyzer,
  title = {BlackRoad OS - blackroad-code-analyzer},
  author = {BlackRoad OS, Inc.},
  year = {2026},
  url = {https://huggingface.co/blackroad-os/blackroad-code-analyzer}
}
```
