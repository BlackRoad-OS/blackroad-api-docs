...
# BlackRoad OS - blackroad-content-generator
...
```bibtex
@software{blackroad_os_blackroad-content-generator,
  title = {BlackRoad OS - blackroad-content-generator},
  author = {BlackRoad OS, Inc.},
  year = {2026},
  url = {https://huggingface.co/blackroad-os/blackroad-content-generator}
}
```
