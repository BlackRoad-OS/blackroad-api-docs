...
# BlackRoad OS - blackroad-agent-orchestrator
...
```bibtex
@software{blackroad_os_blackroad-agent-orchestrator,
  title = {BlackRoad OS - blackroad-agent-orchestrator},
  author = {BlackRoad OS, Inc.},
  year = {2026},
  url = {https://huggingface.co/blackroad-os/blackroad-agent-orchestrator}
}
```
